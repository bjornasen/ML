...
#names  =['pay','mindate','KreditFF','Utslag','Insolvent','Utmätning','SS_Inledd','SS_Avslutad','Firma','SS_Frivillig','Bedrägeri','Godman','Reglerad'] 
...
#dataset_onehot = pandas.get_dummies(dataset_onehot, columns =['KreditFF','Utslag','Insolvent','Utmätning','SS_Inledd','SS_Avslutad','Firma','SS_Frivillig','Bedrägeri','Godman'])
#dataset_onehot = pandas.get_dummies(dataset_onehot, columns=['Reglerad'], prefix = ['Reglerad'])
...
# Split-out validation dataset one hot
array = dataset.values
X = array[:,0:12]
Y = array[:,12]
